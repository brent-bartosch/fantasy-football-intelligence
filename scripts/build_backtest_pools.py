#!/usr/bin/env python3
"""Build `sim.backtest_pool` for the 2023-25 backtest seasons (Phase 3 /
Task 11). Idempotent (each season's rows are fully replaced). Prints
per-season position counts, match rate, and which positions were degraded --
see `ffi.sim.backtest` module docstring for the fixed decisions this
implements (fpts never trusted, K always degraded, DEF neutralized, fp_id-
first name matching, etc.)."""
