...
-- Version 2: Modified for current PostgreSQL setup

-- Create vector extension if not exists (for embeddings)
-- Note: pgvector must be installed first: brew install pgvector
...
-- Store position-specific scoring adjustments based on your league rules
